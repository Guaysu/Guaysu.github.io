...
* 参考： [写给理工科人看的乐理（一）声学基础](https://www.cnblogs.com/devymex/p/3385179.html/)
...
* 音的复合
   最普通最基本的声波就是简谐振动（维基百科）所产生的正弦波了。传统乐器一般都依靠简谐振动发声，比如琴弦、簧片、鼓面等的振动，因此发出的也是正弦波。一个纯粹的正弦波听起来是什么样的呢？<audio id="audio" controls="" preload="none">
